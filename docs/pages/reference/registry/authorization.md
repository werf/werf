...
* [Deploy commands]({{ site.baseurl }}/reference/deploy/deploy_for_kube.html#dapp-kube-deploy) used to read meta information about images from docker registry during deploy.
