...
permalink: documentation/advanced/stapel_image_configuration/git_directive.html
summary: |
...
- `stageDependencies` — a set of masks to monitor for changes that lead to rebuilds of the user stages. This is reviewed in detail in the [Running assembly instructions]({{ site.baseurl }}/documentation/advanced/stapel_image_configuration/assembly_instructions.html) reference.
