...
We recommend you to read the guide for your specific CI/CD system:
 - The [GitLab CI/CD]({{ "documentation/advanced/ci_cd/gitlab_ci_cd.html" | relative_url }}) guide.
 - The [GitHub Actions]({{ "documentation/advanced/ci_cd/github_actions.html" | relative_url }}) guide.
