...
permalink: documentation/advanced/building_images_with_stapelbase_image.html
...
Besides using docker image from a repository, the _base image_ can refer to _image_ or [_artifact_]({{ site.baseurl }}/documentation/advanced/building_images_with_stapelstapel_artifact.html), that is described in the same `werf.yaml`.
