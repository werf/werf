...
Важно понимать, что добавление в образ описанного в директиве `git` кода, происходит на стадии `install`, т.е. на стадии `before install` код еще не доступен (см. [подробней](/stages_arhitecture.html) про стадии сборки).
