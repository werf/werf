...
sidebar: not_used
permalink: not_used/cli/kube_render.html
---
...
Влияют на то, что будет в результате использования шаблона `werf_container_image`. Значение опций соответствует указываемым в [werf dimg push]({{ site.baseurl }}/not_used/cli/dimg_push.html).
