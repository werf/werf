...
* Кэш из build-директории:
  ...
  * Кэш для примонтированных сборочных директорий с использованием опции `from :build_dir`. Подробнее о [включении кэширования с помощью mount](#/mount_for_advanced_build.html#кеширование-сборочных-файлов-между-сборками).
...
Если прервать работу сборщика, убив процесс — все собранные стадии останутся в docker непротеггированными в следующем виде:
...
TODO: очистка dev-кеша через mrproper
