...
Если в v2 вы включали экспериментальные возможности, часть изменений уже действует в вашем окружении. Версии указаны только там, где поведение менялось внутри v3.
