...
**Обновление файлов из Git в Stapel.** При стандартных `git.stageDependencies` изменения исходников запускают команды сборки заново: дополнительных действий из-за этого изменения не требуется. Обновление затрагивает файлы внутри образа, а не рабочую копию Git.
