...
**Если команды сборки изменяют файлы, добавленные из Git, проверьте: запускаются ли эти команды заново при изменении исходников?** При стандартных настройках — да. Если вы вручную задавали `git.stageDependencies`, убедитесь, что нужные файлы включены в зависимости соответствующей стадии. Иначе обновление файла из Git может стереть результат его обработки. Раньше конфликт мог остановить сборку; теперь она может успешно завершиться с неожиданным содержимым образа.

- По возможности сохраняйте результат обработки отдельно от исходников.
