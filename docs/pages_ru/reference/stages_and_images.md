...
_Сигнатура стадии_ используется для [тэгирования](#именование-стадии) _стадии_ в _хранилище стадий_.
...
_Образ_ — это **готовый к использованию** Docker-образ, относящийся к опеределенному состоянию приложения в соответствии со [стратегией тэгирования]({{ site.baseurl }}/documentation/reference/publish_process.html).
