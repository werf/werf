...
* **по веткам:**
    ...
    * Политика применятся к образам, которые тегированы Werf при использовании параметра запуска `--tag-git-branch`.
* **по коммитам:**
    ...
    * Политика применятся к образам, которые тегированы Werf при использовании параметра запуска `--tag-git-commit`.
* **по тегам:**
    ...
    * Политика применятся к образам, которые тегированы Werf при использовании параметра запуска `--tag-git-tag`.
