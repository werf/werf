...
permalink: documentation/guides/applications_guide/gitlab_python_django/020_basic/30_ci.html
layout: guide
toc: false
---
...
{% snippetcut name=".gitlab-ci.yml" url="https://github.com/werf/demos/blob/master/applications-guide/gitlab-django/examples/020-basic-1/.gitlab-ci.yml" %}
```yaml
before_script:
...
{% snippetcut name=".gitlab-ci.yml" url="https://github.com/werf/demos/blob/master/applications-guide/gitlab-django/examples/020-basic/.gitlab-ci.yml" %}
```yaml
