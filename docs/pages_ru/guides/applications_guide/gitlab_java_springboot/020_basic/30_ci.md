...
{% snippetcut name=".gitlab-ci.yml" url="https://github.com/werf/demos/blob/master/applications-guide/gitlab-java-springboot/examples/020-basic/.gitlab-ci.yml" %}
```yaml
before_script:
...
{% snippetcut name=".gitlab-ci.yml" url="https://github.com/werf/demos/blob/master/applications-guide/gitlab-java-springboot/examples/020-basic/.gitlab-ci.yml#L19-24" %}
```yaml
Build:
  stage: build
  script:
...
{% snippetcut name=".gitlab-ci.yml" url="https://github.com/werf/demos/blob/master/applications-guide/gitlab-java-springboot/examples/020-basic/.gitlab-ci.yml#L10-17" %}
```yaml
...
{% snippetcut name=".gitlab-ci.yml" url="https://github.com/werf/demos/blob/master/applications-guide/gitlab-java-springboot/examples/020-basic/.gitlab-ci.yml#L26-33" %}
 ```yaml
 Deploy to Staging:
   extends: .base_deploy
   stage: deploy
...
{% snippetcut name=".gitlab-ci.yml" url="https://github.com/werf/demos/blob/master/applications-guide/gitlab-java-springboot/examples/020-basic/.gitlab-ci.yml#L43-51" %}
 ```yaml
Cleanup:
  stage: cleanup
  script:
