...
```yaml
      env:
      - name: DEBUG
        value: {% raw %}{{ pluck .Values.global.env .Values.app.isDebug | first | default .Values.app.isDebug._default }}{% endraw %}
```
{% endsnippetcut %}
...
* Задайте ключ в переменных приложения, в текущей сессии консоли (например, `export WERF_SECRET_KEY=03bc01702a84dc223d59c9b940fd54ae`)
