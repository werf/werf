...
![alt_text](/images/applications-guide/gitlab-python-django/5.png "image_tooltip")
...
![alt_text](/images/applications-guide/gitlab-python-django/3.png "image_tooltip")
...
![alt_text](/images/applications-guide/gitlab-python-django/6.png "image_tooltip")

Посмотреть статус выполнения pipeline можно в интерфейсе gitlab **CI / CD - Pipelines**

![alt_text](/images/applications-guide/gitlab-python-django/7.png "image_tooltip")
