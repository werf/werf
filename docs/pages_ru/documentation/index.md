...
<div class="overview">
    ...
    <div class="overview__row">
        <div class="overview__step">
            ...
            <div class="overview__step-actions">
                <a class="overview__step-action" href="{{ site.baseurl }}/introduction.html">Введение</a>
            </div>
        </div>
        <div class="overview__step">
            <div class="overview__step-header">
            ...
            <div class="overview__step-actions">
                <a class="overview__step-action" href="{{ site.baseurl }}/installation.html">Установка</a>
                <a class="overview__step-action" href="{{ site.baseurl }}/documentation/quickstart.html">Быстрый старт</a>
            </div>
        </div>
    </div>
    <div class="overview__step">
        ...
        <div class="overview__step-actions">
            <a class="overview__step-action" href="{{ site.baseurl }}/documentation/using_with_ci_cd_systems.html">Использование werf в системах CI/CD</a>
        </div>
    </div>
    <div class="overview__step">
        <div class="overview__step-header">
        ...
        <div class="overview__step-actions">
            <a class="overview__step-action" href="{{ site.baseurl }}/documentation/guides.html">Руководства</a>
        </div>
    ...
    <div class="overview__step">
        ...
        <div class="overview__step-actions">
            <a class="overview__step-action" href="{{ site.baseurl }}/documentation/reference/werf_yaml.html">Справочник</a>
        </div>
        <div class="overview__step-info">
<div markdown="1">
 ...
 - [Интерфейс командной строки]({{ site.baseurl }}/documentation/reference/cli/overview.html) содержит полный список команд werf с описанием.
    ...
    <div class="overview__step">
        ...
        <div class="overview__step-actions">
            <a class="overview__step-action" href="{{ site.baseurl }}/documentation/advanced/configuration/supported_go_templates.html">Документация продвинутого уровня</a>
        </div>
        <div class="overview__step-info">
<div markdown="1">
 ...
 - [Поддерживаемые реализации container registry]({{ site.baseurl }}/documentation/advanced/supported_registry_implementations.html) — приводятся общие сведения о поддерживаемых реализациях container registry и рассказывается об авторизации.
</div>
        </div>
    </div>
    <div class="overview__step">
        ...
        <div class="overview__step-actions">
            <a class="overview__step-action" href="{{ site.baseurl }}/documentation/internals/building_of_images/build_process.html">Внутренние механизмы werf</a>
        </div>
        <div class="overview__step-info">
