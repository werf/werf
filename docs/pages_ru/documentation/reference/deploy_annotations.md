...
Больше информации о том, что такое чарт, шаблоны и пр. доступно в [базовой статье о деплое]({{ "documentation/advanced/helm/basics.html" | true_relative_url: page.url }}).
