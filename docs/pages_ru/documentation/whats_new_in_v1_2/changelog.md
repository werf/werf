...
### Работа с сабчартами
 ...
 - См. больше информации [по зависимым чартам]({{ "/documentation/advanced/helm/configuration/chart_dependencies.html" | true_relative_url }}) и [гитерминизму]({{ "/documentation/advanced/helm/configuration/giterminism.html#сабчарты-и-гитерминизм" | true_relative_url }}).
