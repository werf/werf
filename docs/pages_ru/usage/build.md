...
- [Конфигурация образов](#конфигурация-образов)
  ...
  - [Образы Dockerfile](#образы-dockerfile)
    - [contextAddFiles](#contextaddfiles)
  - [Образы stapel](#образы-stapel)
  - [Зависимости между образами](#зависимости-между-образами)
- [Процесс сборки и его конфигурация](#процесс-сборки-и-его-конфигурация)
...
- [Сборочный бэкенд](#сборочный-бэкенд)
  - [Конфигурация сборочного бекэнда](#конфигурация-сборочного-бекэнда)
    - [Режим сборки с использованием Buildah](#режим-сборки-с-использованием-buildah)
...
## Процесс сборки и его конфигурация
...
### Конфигурация сборочного бекэнда
