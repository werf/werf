...
> **ВАЖНО.** Автоматической миграции уже существующих метаданных из основного репозитория в `--meta-repo` не предусмотрено. Включайте этот флаг с самого начала жизни проекта либо учитывайте, что метаданные, уже находящиеся в основном репозитории, будут постепенно перегенерированы в ходе последующих сборок и очисток.
