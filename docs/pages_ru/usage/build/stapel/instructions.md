...
Так же SSH-агент может быть использован в пользовательских инструкциях.
Подробно о работе SSH-агента в werf можно узнать [здесь]({{ "docs/pages_ru/usage/build/process.html#Использование-SSH-агента-при-сборке" | true_relative_url }}).
