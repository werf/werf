...
Директива `from` определяет имя и тег _базового образа_. В качестве базового образа может быть использован как образ из текущего проекта, так и любой другой внешний ообраз.
