...
Переданные [values для helm chart]({{ "/usage/deploy/values.html" | true_relative_url }}), аннотаций и лейблов для ресурсов будут объединены с теми values, аннотациями и лейблами, которые были указаны при публикации бандлов и зашиты в него.
