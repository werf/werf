# DON'T FORGET TO MAKE CHANGES ALSO IN docs/site/.helm/_rewrites.tpl if necessary.
{{- define "rewrites" }}
...
rewrite ^(/v1\.2(\-[a-z]+)?)+/documentation/reference/stages_and_images\.html$                $1/documentation/internals/stages_and_storage.html permanent;
...
rewrite ^(/v1\.2(\-[a-z]+)?)+/documentation/reference/deploy_process/working_with_secrets\.html$    $1/documentation/advanced/helm/configuration/secrets.html permanent;
...
rewrite ^(/v1\.2(\-[a-z]+)?)?/documentation/reference/development_and_debug/stage_introspection\.html$  $1/documentation/advanced/development_and_debug/stage_introspection.html permanent;
