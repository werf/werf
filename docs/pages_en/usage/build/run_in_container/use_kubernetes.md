...
Make sure you meet all [system requirements]({{ "usage/build/buildah_mode.html#system-requirements" | true_relative_url }}) and select one of the [available operating modes]({{ "usage/build/run_in_containers/how_it_works.html#modes-of-operation" | true_relative_url }}) and navigate to it.
...
Select one of the [available operating modes]({{ "usage/build/run_in_containers/how_it_works.html#modes-of-operation" | true_relative_url }}) and navigate to it.
