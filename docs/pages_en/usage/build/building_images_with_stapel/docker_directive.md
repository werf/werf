...
permalink: usage/build/building_images_with_stapel/docker_directive.html
...
If need to use special environment variables in build-time of your application image, such as `TERM` environment, you should use a [base image]({{ "usage/build/building_images_with_stapel/base_image.html" | true_relative_url }}) with these variables.
