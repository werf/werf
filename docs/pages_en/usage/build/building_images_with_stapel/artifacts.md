---
title: Artifacts
permalink: usage/build/building_images_with_stapel/artifacts.html
...
The instructions associated with the _from stage_, namely the [_base image_]({{ "usage/build/building_images_with_stapel/base_image.html" | true_relative_url }}) and [mounts]({{ "usage/build/building_images_with_stapel/mount_directive.html" | true_relative_url }}), and also [imports]({{ "usage/build/building_images_with_stapel/import_directive.html" | true_relative_url }}) remain unchanged.
...
Read about working with _git repositories_ in the corresponding [article]({{ "usage/build/building_images_with_stapel/git_directive.html" | true_relative_url }}).
