...
permalink: usage/build/building_images_with_stapel/assembly_instructions.html
...
werf provides distribution-agnostic bash binary, so you do not need a bash binary in the [base image]({{ "usage/build/building_images_with_stapel/base_image.html" | true_relative_url }}).
...
- changes in files being imported from [artifacts]({{ "usage/build/building_images_with_stapel/artifacts.html" | true_relative_url }})
