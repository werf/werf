...
> **NOTE!** It is not recommended to use environment variables in the `werf.yaml`, more info [in the article]({{ "/usage/project_configuration/giterminism.yaml" | true_relative_url }}).
