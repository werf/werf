...
werf.yaml ([https://werf.io/documentation/reference/werf_yaml.html#configuring-cleanup-policies]({{ "/documentation/reference/werf_yaml.html#configuring-cleanup-policies" | true_relative_url: page.url }})).
