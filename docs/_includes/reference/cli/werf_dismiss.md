...
Read more info about Helm Release name, Kubernetes Namespace and how to change it: [https://werf.io/documentation/usage/deploy/releases/naming.html]({{ "/usage/deploy/releases/naming.html" | true_relative_url }})
