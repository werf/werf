...
[Создайте ваше первое приложение с werf](https://ru.werf.io/documentation/v1.1/guides/getting_started.html) или начните знакомство с чтения [документации](https://ru.werf.io/).
