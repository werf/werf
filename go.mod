...
require (
	...
	github.com/werf/nelm v1.23.2-0.20260327172522-9fd804c04354
...
replace (
	...
	github.com/distribution/reference => github.com/distribution/reference v0.5.0 // docker/distribution v2.8.3 deprecated shim calls SplitHostname removed in v0.6.0
	github.com/docker/buildx => github.com/werf/3p-docker-buildx v0.18.0-rc1 // upstream not maintained
