...
```bash
curl -L https://dl.bintray.com/flant/werf/v1.0.0-alpha.8/werf-darwin-amd64-v1.0.0-alpha.8 -o /tmp/werf
chmod +x /tmp/werf
...
```bash
curl -L https://dl.bintray.com/flant/werf/v1.0.0-alpha.8/werf-linux-amd64-v1.0.0-alpha.8 -o /tmp/werf
chmod +x /tmp/werf
sudo mv /tmp/werf /usr/local/bin/werf
```
