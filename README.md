...
#### Директория проекта
Директория проекта — это директория, в которой находится директория .dapps или, при ее отсутствии — это директория, содержащая Dappfile.
...
#### Приложение
Приложение (application) — это набор правил, объединенных в одном Dappfile, по которым происходит сборка одного или нескольких дапов.
