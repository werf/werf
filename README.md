...
* Могут использоваться такие же директивы, как у приложения, но с некоторыми особенностями:
  ...
  * [shell](#shell): добавляется директива build_artifact.
...
* Установка [mdapp модуля](#mdapp-модуль).
  * Атрибуты.
    * Файл attributes/\<стадия\>/\<файл-атрибутов\>.rb устанавливается в attributes/\<файл-атрибутов\>.rb.
      * Для каждого включенного файла атрибутов при его наличии.
    * Файл attributes/common/\<файл-атрибутов\>.rb устанавливается в attributes/\<файл-атрибутов\>.rb.
      * Для каждого включенного файла атрибутов при его наличии.
    * Недопустимо наличие одинаковых имен файлов в директории стадии и common.
  * Файлы.
