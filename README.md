...
#### Chef приложение
Chef приложение — это приложение, для сборки которого используются [chef cookbook приложения](#Chef-cookbook-приложения) и [mdapp модули](#Mdapp-модуль).

#### Chef cookbook приложения
Chef cookbook приложения — это основной chef cookbook, связанный с одним [приложением](#Приложение).
* Обязательные файлы:
  * metadata.rb
...
* Используется для:
  * Кэширования [дерева chef cookbooks](#Дерево-chef-cookbooks) между сборками.
