...
Директория приложения (home path)
...
#### Build директория
Build директория (build path) — это директория для хранения кэша и производных данных сборок.
* Используется для:
...
#### Tmp директория
Tmp директория (tmp path) — это временная рабочая директория сборщика [приложения](#Приложение).
