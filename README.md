...
* Базовое имя приложения может быть переопределено в Dappfile.
...
* Имя docker образа стадии: dappstage-\<[имя проекта](#Имя-проекта)\>-\<[базовое имя приложения](#Базовое-имя-приложения)\>:\<[сигнатура стадии](#Сигнатура-стадии)\>
