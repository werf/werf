...
* Установка [cookbook\`а приложения](#cookbook-приложения).
  * Атрибуты.
    * Хэш атрибутов, совмещенных из [chef.attribute](#chefattribute) и [chef.\<стадия\>\_attribute](#chefстадия_attribute)
      * Устанавливается в файл attributes/normal.rb.
      * Используется тип chef атрибутов: normal.
  * Файлы.
