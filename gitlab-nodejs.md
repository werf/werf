...
Наше приложение будет основываться на шаблонах приложений [https://github.com/chandantudu/nodejs-login-registration](https://github.com/chandantudu/nodejs-login-registration) и [https://itnext.io/build-a-group-chat-app-in-30-lines-using-node-js-15bfe7a2417b](https://itnext.io/build-a-group-chat-app-in-30-lines-using-node-js-15bfe7a2417b). С их помощью мы сможем реализовать процесс сборки и деплоя легковесного чата с собственной авторизацией.
...
Прежде чем описывать задачи в ansible, необходимо добавить еще два поля.
