...
werf mounts _stapel image_ into each build container when building docker images with _stapel builder_ to enable ansible, git service operations and for other service purposes. More info about _stapel builder_ are available [in the article]({{ "usage/build/build_process.html#building-a-stage-of-the-stapel-image-and-stapel-artifact" | true_relative_url }}).
