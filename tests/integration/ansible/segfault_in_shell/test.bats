setup() {
	cd tests/integration/ansible/segfault_in_shell
}
...
@test "Check exit code of a program that segfaults (https://github.com/flant/werf/issues/1807)" {
	# NOTE: Issues:
	# NOTE:  - https://github.com/ansible/ansible/issues/63123
	# NOTE:  - https://github.com/flant/werf/issues/1807
	# NOTE:
