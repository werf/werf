...
var _ = Describe("Template file functions", func() {
	...
	DescribeTable("ConfigGoTemplateFilesExists",
		...
		Entry("should return false if the file does not exist in the Git repository (missing)",
		...
		Entry("should return false if the file does not exist in the Git repository (not committed)",
			func(ctx context.Context, relPath string) {
				pathMatcher.EXPECT().IsPathMatched(relPath).Return(false)
	...
	DescribeTable("ConfigGoTemplateFilesIsDir",
		...
		Entry("should return false if dir does not exist in the Git repository (missing)",
			func(ctx context.Context, relPath string) {
				pathMatcher.EXPECT().IsPathMatched(relPath).Return(false)
		...
		Entry("should return false if dir does not exist in the Git repository (not committed)",
			func(ctx context.Context, relPath string) {
				pathMatcher.EXPECT().IsPathMatched(relPath).Return(false)
...
type MockFunc func(ctx context.Context, relPath string)
