...
func (mr *MockgiterminismConfigMockRecorder) IsUncommittedDockerfileAccepted(relPath interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockgiterminismConfigMockRecorder) IsUncommittedDockerignoreAccepted(relPath interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockfileSystemMockRecorder) DirExists(path interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockfileSystemMockRecorder) FileExists(p interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockfileSystemMockRecorder) RegularFileExists(path interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockfileSystemMockRecorder) Walk(root, fn interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
