...
func (r FileReader) LoadChartDirWithIgnoreRules(ctx context.Context, chartDir string, rules ChartIgnoreRules) ([]*file.ChartExtenderBufferedFile, error) {
	relDir := r.absolutePathToProjectDirRelativePath(chartDir)
...
func (r FileReader) loadChartDir(ctx context.Context, relDir string, rules ChartIgnoreRules) ([]*file.ChartExtenderBufferedFile, error) {
