...
var _ = DescribeTable("FROM digest",
	...
	Entry("FROM with BaseImageReference option only ", NewTestData(
		instruction.NewFrom("test-image-reference", "", "", &stage.BaseStageOptions{}),
	...
	Entry("FROM with BaseImageRepoDigest option only", NewTestData(
		instruction.NewFrom("", "test-image-repo-digest", "", &stage.BaseStageOptions{}),
	...
	Entry("FROM with ImageCacheVersion option only", NewTestData(
		instruction.NewFrom("", "", "image-cache-version", &stage.BaseStageOptions{}),
		"9de9441477c5d35efbc350204fe9b71ad80116bd17c77972ac34232fb23e7c0b",
		TestDataOptions{},
	)),

	Entry("FROM with full options", NewTestData(
		instruction.NewFrom("test-image-reference", "test-image-repo-digest", "image-cache-version", &stage.BaseStageOptions{}),
