...
// TestAI_GraphScheduler_FastChainDoesNotWaitForUnrelatedSlowImage is the core
...
// to complete first.
func TestAI_GraphScheduler_FastChainDoesNotWaitForUnrelatedSlowImage(t *testing.T) {
...
func TestAI_GraphScheduler_DiamondDependencyReadyOnlyAfterBothParents(t *testing.T) {
