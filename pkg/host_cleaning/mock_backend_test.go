...
// Source: ../container_backend/interface.go

// Package host_cleaning_test is a generated GoMock package.
...
func (mr *MockContainerBackendMockRecorder) BuildDockerfile(ctx, dockerfile, opts interface{}) *gomock.Call {
...
func (m *MockContainerBackend) BuildDockerfileStage(ctx context.Context, baseImage string, opts container_backend.BuildDockerfileStageOptions, instructions ...container_backend.InstructionInterface) (string, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, baseImage, opts}
...
func (mr *MockContainerBackendMockRecorder) BuildDockerfileStage(ctx, baseImage, opts interface{}, instructions ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, baseImage, opts}, instructions...)
...
func (mr *MockContainerBackendMockRecorder) BuildStapelStage(ctx, baseImage, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockContainerBackendMockRecorder) CalculateDependencyImportChecksum(ctx, dependencyImport, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockContainerBackendMockRecorder) ClaimTargetPlatforms(ctx, targetPlatforms interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockContainerBackendMockRecorder) Containers(ctx, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockContainerBackendMockRecorder) GetImageInfo(ctx, ref, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockContainerBackendMockRecorder) Images(ctx, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockContainerBackendMockRecorder) Info(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockContainerBackendMockRecorder) PostManifest(ctx, ref, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockContainerBackendMockRecorder) Pull(ctx, ref, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockContainerBackendMockRecorder) PullImageFromRegistry(ctx, img interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockContainerBackendMockRecorder) Push(ctx, ref, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockContainerBackendMockRecorder) RefreshImageObject(ctx, img interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockContainerBackendMockRecorder) RemoveHostDirs(ctx, mountDir, dirs interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockContainerBackendMockRecorder) RemoveImage(ctx, img interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockContainerBackendMockRecorder) RenameImage(ctx, img, newImageName, removeOldName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockContainerBackendMockRecorder) Rm(ctx, name, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockContainerBackendMockRecorder) Rmi(ctx, ref, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockContainerBackendMockRecorder) Tag(ctx, ref, newRef, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockContainerBackendMockRecorder) TagImageByName(ctx, img interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
