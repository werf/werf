...
func (s *Session) monitorForExit(exited chan<- struct{}) {
	// Workaround for the issue https://github.com/golang/go/issues/24050
	...
	go func() {
		// Give 30 seconds for Command object
		// to detect command termination by itself,
		// after that terminate forcefully.
