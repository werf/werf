...
Read more info about Helm chart structure, Helm Release name, Kubernetes Namespace and how to change it: https://werf.io/documentation/usage/deploy/releases/naming.html`
	...
	docs.LongMD = "Build and push images, then deploy application into Kubernetes.\n\n" +
		...
		"how to change it: https://werf.io/documentation/usage/deploy/releases/naming.html\n"
	return docs
}
