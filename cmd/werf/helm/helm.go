	...
	for len(commandsQueue) > 0 {
		...
		if cmd.Runnable() {
			...
			cmd.RunE = func(cmd *cobra.Command, args []string) error {
				...
				helm.InitActionConfig(ctx, common.GetOndemandKubeInitializer(), namespace, cmd_helm.Settings, helmRegistryClientHandle, actionConfig, helm.InitActionConfigOptions{
