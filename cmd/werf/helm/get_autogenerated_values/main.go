...
func runGetServiceValues() error {
	...
	serviceValues, err := deploy.GetServiceValues(context.Background(), projectName, imagesRepo.String(), namespace, tag, tagStrategy, imagesInfoGetters, deploy.ServiceValuesOptions{Env: environment})
	if err != nil {
