...
These values includes project name, docker images ids and other`),
	...
	common.SetupDisableGiterminism(&getAutogeneratedValuedCmdData, cmd)
	common.SetupNonStrictGiterminismInspection(&getAutogeneratedValuedCmdData, cmd)
...
func runGetServiceValues() error {
	...
	if err := giterminism_inspector.Init(giterminism_inspector.InspectionOptions{NonStrict: *getAutogeneratedValuedCmdData.NonStrictGiterminismInspection}); err != nil {
		return err
	}
	...
	werfConfig, err := common.GetRequiredWerfConfig(ctx, projectDir, &getAutogeneratedValuedCmdData, localGitRepo, config.WerfConfigOptions{DisableGiterminism: *getAutogeneratedValuedCmdData.DisableGiterminism, Env: *getAutogeneratedValuedCmdData.Environment})
	if err != nil {
