...
These values includes project name, docker images ids and other`),
	...
	common.SetupLooseGiterminism(&getAutogeneratedValuedCmdData, cmd)
	...
	common.SetupDev(&getAutogeneratedValuedCmdData, cmd)
...
func runGetServiceValues() error {
	...
	werfConfig, err := common.GetRequiredWerfConfig(ctx, projectDir, &getAutogeneratedValuedCmdData, localGitRepo, config.WerfConfigOptions{Env: *getAutogeneratedValuedCmdData.Environment})
	if err != nil {
