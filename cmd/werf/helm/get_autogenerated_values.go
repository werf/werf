...
These values includes project name, docker images ids and other`),
	...
	common.SetupDisableGitermenism(&getAutogeneratedValuedCmdData, cmd)
	common.SetupNonStrictGitermenismInspection(&getAutogeneratedValuedCmdData, cmd)
...
func runGetServiceValues() error {
	...
	if err := gitermenism_inspector.Init(gitermenism_inspector.InspectionOptions{NonStrict: *getAutogeneratedValuedCmdData.NonStrictGitermenismInspection}); err != nil {
		return err
	}
	...
	werfConfig, err := common.GetRequiredWerfConfig(ctx, projectDir, &getAutogeneratedValuedCmdData, localGitRepo, config.WerfConfigOptions{DisableGitermenism: *getAutogeneratedValuedCmdData.DisableGitermenism, Env: *getAutogeneratedValuedCmdData.Environment})
	if err != nil {
