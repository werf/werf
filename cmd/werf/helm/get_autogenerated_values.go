...
func runGetServiceValues() error {
	...
	werfConfig, err := common.GetRequiredWerfConfig(ctx, projectDir, &getAutogeneratedValuedCmdData, localGitRepo, common.GetWerfConfigOptions(&getAutogeneratedValuedCmdData, false))
	if err != nil {
