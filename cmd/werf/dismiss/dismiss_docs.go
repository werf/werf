...
Read more info about Helm Release name, Kubernetes Namespace and how to change it: https://werf.io/documentation/usage/deploy/releases/naming.html`
	...
	docs.LongMD = "Delete application from Kubernetes.\n\n" +
		...
		"to change it: https://werf.io/documentation/usage/deploy/releases/naming.html"
