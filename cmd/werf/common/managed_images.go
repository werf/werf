...
func GetManagedImagesNames(ctx context.Context, projectName string, registryStorage storage.RegistryStorage, werfConfig *config.WerfConfig) ([]string, error) {
	var names []string
	if publishedNames, err := registryStorage.GetManagedImages(ctx, projectName); err != nil {
