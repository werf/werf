...
func MakeChartDirLoadFunc(ctx context.Context, localGitRepo *git_repo.Local, projectDir string, disableGiterminism bool) func(dir string) ([]*loader.BufferedFile, error) {
...
func MakeLocateChartFunc(ctx context.Context, localGitRepo *git_repo.Local, projectDir string, disableGiterminism bool) func(name string, settings *cli.EnvSettings) (string, error) {
	if disableGiterminism || localGitRepo == nil {
		return nil
	}
...
func MakeHelmReadFileFunc(ctx context.Context, localGitRepo *git_repo.Local, projectDir string, disableGiterminism bool) func(filePath string) ([]byte, error) {
	if disableGiterminism || localGitRepo == nil {
		return nil
	}
