...
Default $WERF_IMAGES_REPO_MODE or auto mode (default repo mode for images repo implementation)`, docker_registry.MultirepoRepoMode, docker_registry.MonorepoRepoMode))
}
