  ...
  module DimgSpecHelper
    ...
    [:install, :setup].each do |stage_name|
      define_method "expect_#{stage_name}_image" do
        ...
        public_send("expect_#{prev_stage(stage_name)}_image")
      end
    end
