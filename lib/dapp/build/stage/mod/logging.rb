      ...
      module Mod
        ...
        module Logging
          ...
          def log_build
            ...
            end if dimg.dapp.log_verbose? && !should_be_quiet?
          end
          ...
          def log_state(state_code, styles: {})
            dimg.dapp.log_state(log_name,
                                   state: dimg.dapp.t(code: state_code, context: 'state'),
                                   styles: styles) unless should_be_quiet?
          end

          def log_image_build_process
            return yield if should_be_quiet?
            dimg.dapp.log_process(log_name, process: dimg.dapp.t(code: 'status.process.building'),
