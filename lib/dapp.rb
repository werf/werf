...
require 'dapp/cli/command/example'
require 'dapp/cli/command/example/base'
require 'dapp/cli/command/example/list'
require 'dapp/cli/command/example/create'
...
require 'dapp/dapp/command/example/common'
require 'dapp/dapp/command/example/create'
require 'dapp/dapp/command/example/list'
require 'dapp/dapp'
require 'dapp/kube'
