...
require 'dapp/build/stage/install/ga_pre_patch_dependencies'
require 'dapp/build/stage/install/ga_pre_patch'
require 'dapp/build/stage/install/install'
require 'dapp/build/stage/install/ga_post_patch_dependencies'
require 'dapp/build/stage/install/ga_post_patch'
require 'dapp/build/stage/artifact'
require 'dapp/build/stage/before_setup'
require 'dapp/build/stage/setup/ga_pre_patch_dependencies'
require 'dapp/build/stage/setup/ga_pre_patch'
require 'dapp/build/stage/setup/setup'
require 'dapp/build/stage/setup/chef_cookbooks'
require 'dapp/build/stage/setup/ga_post_patch_dependencies'
require 'dapp/build/stage/setup/ga_post_patch'
require 'dapp/build/stage/ga_latest_patch'
require 'dapp/build/stage/docker_instructions'
require 'dapp/project/lock'
require 'dapp/application/logging' # FIXME: remove when moved to project
